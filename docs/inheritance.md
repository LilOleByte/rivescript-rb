...
## string[] get_topic_triggers (RiveScript rs, string topic, object triglvl, int depth, int inheritance, int inherited)
...
## string[] get_topic_tree (RiveScript rs, string topic, int depth)
